...
public class DynamicListView extends ListView {
    ...
    public AdapterView.OnItemLongClickListener mOnItemLongClickListener =
            new AdapterView.OnItemLongClickListener() {
                public boolean onItemLongClick(AdapterView<?> arg0, View arg1, int pos, long id) {
                    ...
                    Log.v("dynamicListView", "mDownXY: " + mDownX + ", " + mDownY);
                    Log.v("dynamicListView", "position: " + position);
    ...
    private BitmapDrawable getAndAddHoverView(View v) {
        ...
        // Get parts of view we need to change for the bitmap
        TextView number = (TextView) v.findViewById(R.id.number);
        TextView dot = (TextView) v.findViewById(R.id.dot);
        ImageView moveIcon = (ImageView) v.findViewById(R.id.moveIcon);
        ...
        // Change views back to original
        number.setVisibility(VISIBLE);
        dot.setVisibility(VISIBLE);
        moveIcon.setVisibility(INVISIBLE);
    ...
    private void updateNeighborViewsForID(long itemID) {
        ...
        SetListAdapter adapter = ((SetListAdapter) getAdapter());
    ...
    private void swapElements(ArrayList arrayList, int indexOne, int indexTwo) {
        Set Set1 = (Set) arrayList.get(indexOne);
        Set Set2 = (Set) arrayList.get(indexTwo);

        if (!(Set1.isWarmUp() || Set2.isWarmUp())){
            int tmp = Set1.getNumber();
            Set1.setNumber(Set2.getNumber());
            Set2.setNumber(tmp);
        }
        int tmp = Set1.getPosition();
        Set1.setPosition(Set2.getPosition());
        Set2.setPosition(tmp);

        arrayList.set(indexOne, Set2);
        arrayList.set(indexTwo, Set1);
    ...
    public void setList(ArrayList<Set> cheeseList) {
        mList = cheeseList;
    }
